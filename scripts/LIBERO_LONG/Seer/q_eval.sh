...
finetune_from_pretrained_ckpt="checkpoints/q-seer-libero/finetune_Seer_ptbs512_lr0.0001_no-tanh_log-clamp-libero_to_q-model/1.pth"
...
torchrun --nnodes=${node} --nproc_per_node=${node_num} --master_port=10212 q_libero_eval.py \
    --traj_cons \
    --rgb_pad 10 \
    --gripper_pad 4 \
